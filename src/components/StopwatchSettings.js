import { Accordion, Button, Checkbox, Flex, Text, TextInput } from "@mantine/core";
import { useForm } from "@mantine/form";
import Stopwatch from "./Stopwatch";
import { toSecondsFromDuration, toTimeString } from "../utils/utils";


const StopwatchSettings = ({seconds, setSeconds,inputRef, interval, hourlyNotification, setHourlyNotification}) => {
